...
class WeatherModel {
  ...
  String getImage() {
    if (weatherStateName == 'Sunny' ||
      ...
      return 'assets/images/rainy.png';
        ...
        weatherStateName == 'Patchy light rain with thunder' || weatherStateName == 'Thunder') {
  ...
  @override
  String toString() {
    return 'temp = $temp , max temp = $maxTemp , min temp = $minTemp , weather state = $weatherStateName';
  }
}
